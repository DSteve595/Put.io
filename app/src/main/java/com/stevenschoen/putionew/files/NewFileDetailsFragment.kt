...
class NewFileDetailsFragment : RxFragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        return inflater.inflate(R.layout.newfiledetails, container, false).apply {
            ...
            val playActionView: Button = findViewById(R.id.newfiledetails_play)
            val playProgressBarView: View = findViewById(R.id.newfiledetails_play_progressbar)
            val playMoreView: View = findViewById(R.id.newfiledetails_play_more)
            ...
            val downloadActionView: Button = findViewById(R.id.newfiledetails_download)
            val downloadProgressBarView: View = findViewById(R.id.newfiledetails_download_progressbar)
            val downloadMoreView: View = findViewById(R.id.newfiledetails_download_more)
